...
## 1. Guidelines for development of Software Artifacts

**1.1.** **Every software artifact MUST have a owner.**
...
**1.2.** **Every software artifact MUST have a wiki page.**
...
**1.3.** **Every software artifact MUST have its backlog maintained.**
...
**1.4.** **Every software artifact MUST have its source code managed by a version control system.**
...
**1.6.** **Every software artifact MUST be developed using design techniques that favor its reuse.**
...
**1.7.** **Every software artifact MUST be registered in a continuous integration tool.**
...
**1.8.** **Every software artifact MUST be registered in a source code quality analysis tool.**
...
**1.9.** **Every software artifact MUST be registered in a continuous deployment tool.**
...
**1.10.** **Every software artifact MUST adhere to a consistent versioning scheme.**
...
**1.11.** **Every software artifact MUST be registered in a reuse management tool.**
...
**1.12.** **Every software artifact MUST consume other software artifacts only through reuse management tools.**
...
**1.13.** **Every software artifact MUST have license terms.**
...
**1.14.** **Relevant software artifact MAY have its evolution published in management boards.**
...
## 2. Guidelines for development of Software Systems

**2.1.** **All guidelines applicable to software artifacts MUST also be applicable to software systems**.
...
**2.2.** **Every software system MUST have its development or extension managed by a software project.**
...
**2.3.** **Every software system MUST have its requirements validated by a software quality assurance team**.
...
**2.4.** **Every software system MUST publish its evolution in a management board**.
...
## 3. Guidelines for management of Software Projects
...
**3.3.** **Every software project MUST have a Technical Leader.**
...
**3.4.** **Every software project MUST have a kickoff meeting.**
...
**3.5.** **Every software project MUST balance agility and discipline.**
...
**3.6.** **Every software project MUST have a wiki page.**
...
**3.7.** **Every software project MUST have its backlog maintained.**
...
**3.8.** **Every software project MUST publish its evolution in a management board.**
...
**3.9.** **Every software MUST register and keep its scope, due dates and requirements updated and available to the development team during all the project duration.**
...
**3.10.** **Every software project MUST perform frequent short meetings.**
...
**3.11.** **Every software project MUST have its development performed in an iterative way.**
...
**3.12.** **Every software project MUST perform partial deliveries to the software quality assurance team.**
...
**3.13.** **Every software project MUST perform partial deliveries to the customer.**
...
**3.14.** **Every software project MUST have a closing celebration.**
