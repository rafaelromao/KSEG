# KEG-SW - Key Engineering Guidelines for Software Development
...
## KEG-SW 1. Guidelines for development of Software Artifacts

**KEG-SW 1.1.** **Every software artifact MUST have a owner.**
...
**KEG-SW 1.2.** **Every software artifact MUST have a wiki page.**
...
**KEG-SW 1.3.** **Every software artifact MUST have its backlog maintained.**
...
**KEG-SW 1.4.** **Every software artifact MUST have its source code managed by a version control system.**
...
**KEG-SW 1.5.** **Every software artifact MUST have its specifications verified by automated tests.**
...
**KEG-SW 1.6.** **Every software artifact MUST be developed using design techniques that favor its reuse.**
...
**KEG-SW 1.7.** **Every software artifact MUST be registered in a continuous integration tool.**
...
**KEG-SW 1.8.** **Every software artifact MUST be registered in a source code quality analysis tool.**
...
**KEG-SW 1.9.** **Every software artifact MUST be registered in a continuous deployment tool.**
...
**KEG-SW 1.10.** **Every software artifact MUST adhere to a consistent versioning scheme.**
...
**KEG-SW 1.11.** **Every software artifact MUST be registered in a reuse management tool.**
...
**KEG-SW 1.12.** **Every software artifact MUST consume other software artifacts only through reuse management tools.**
...
**KEG-SW 1.13.** **Every software artifact MUST have license terms.**
...
## KEG-SW 2. Guidelines for development of Software Systems

**KEG-SW 2.1.** **All guidelines applicable to software artifacts MUST also be applicable to software systems**.
...
**KEG-SW 2.2.** **Every software system MUST have its development or extension managed by a software project.**
...
**KEG-SW 2.3.** **Every software system MUST have its requirements validated by a software quality assurance team**.
...
**KEG-SW 2.4.** **Every software system MUST publish its evolution in a management board**.
...
## KEG-SW 3. Guidelines for management of Software Projects

**KEG-SW 3.1.** **Every software project MUST be supervised by a Project Management Office.**
...
**KEG-SW 3.2.** **Every software project MUST have a Project Manager.**
...
**KEG-SW 3.3.** **Every software project MUST have a Technical Leader.**
...
**KEG-SW 3.4.** **Every software project MUST have a kickoff meeting.**
...
**KEG-SW 3.5.** **Every software project MUST balance agility and discipline.**
...
**KEG-SW 3.6.** **Every software project MUST have a wiki page.**
...
**KEG-SW 3.7.** **Every software project MUST have its backlog maintained.**
...
**KEG-SW 3.8.** **Every software project MUST publish its evolution in a management board.**
...
**KEG-SW 3.9.** **Every software MUST register and keep its scope, due dates and requirements updated and available to the development team during all the project duration.**
...
**KEG-SW 3.10.** **Every software project MUST perform frequent short meetings.**
...
**KEG-SW 3.11.** **Every software project MUST have its development performed in an iterative way.**
...
**KEG-SW 3.12.** **Every software project MUST perform partial deliveries to the software quality assurance team.**
...
**KEG-SW 3.13.** **Every software project MUST perform partial deliveries to the customer.**
...
**KEG-SW 3.14.** **Every software project MUST have a closing celebration.**
